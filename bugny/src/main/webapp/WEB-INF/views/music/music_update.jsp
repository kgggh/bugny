...
<div class="container" id="container">
	...
	<form name="form2"  id="form2" role="form2" >
		<div class="mb-3">
			...
			<input type="text" class="form-control" name="title" id="title" placeholder="제목을 입력해 주세요" value="${musicUpdate.title }">
		</div>
		<div class="mb-3">
			<label for="singer">가수</label>
			<input type="text" class="form-control" name="singer" id="singer" placeholder="가수를 입력해 주세요" value="${musicUpdate.singer }">
		</div>
		<div class="mb-3">
			<label for="releaseDate">발매일</label>
			<input type="date" class="form-control" name="releaseDate" id="releaseDate" placeholder="발매일을 작성해주세요. Ex)yyyy-mm-dd" value="${musicUpdate.releaseDate }">
		</div>
		<div class="contentDiv">
			<label for="album">앨범커버</label>
		 	<textarea id="txtContent" name="album" rows="30" style="width:100%;" >${musicUpdate.album }</textarea>
		</div>
		<div class="selectBtn">
			<input type="hidden" name="music_idx" value="${musicUpdate.music_idx }">
			<button type="submit"  class="btn btn-sm btn-secondary" id="btnModify" onclick="onModify()">수정완료</button>
		</div>
	</form>
</div>
</body>
